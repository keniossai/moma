                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-sm-6">
                                ...
                                <form action="{{ route('api.users.update', $user) }}" method="post"
                                      class="form-horizontal form-element col-12 x-submit" data-then="reload">
                                    @csrf
                                    @method('PUT')
                                    <textarea name="" id="" rows="4" placeholder="Enter bio here..." class="form-control">{{ $user->bio }}</textarea>
                                </form>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="settings">
                                            ...
                                            <div class="box no-shadow p-5">
                                                <form action="{{ route('api.users.update', $user) }}" method="post" id="user-update-form"
                                                      class="form-horizontal form-element col-12 x-submit" data-then="reload">
                                                    @csrf
                                                    @method('PUT')
                                                ...
                                                <div class="form-group row">
                                                    <div class="gap-items">
                                                        <button class="btn btn-primary"
                                                                onclick="document.getElementById('user-update-form').submit()"
                                                        ><i class="fa fa-user-pen" aria-hidden="true"></i> Update Profile</button>
